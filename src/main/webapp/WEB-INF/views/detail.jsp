...
<body>
    <div id="container">
        ...
        <div class="ct main">
            <div>
                                    ...
                                    <li class="item" style="width: 414px;">
                                        ...
                                        <div class="visual_txt">
                                            <div class="visual_txt_inn">
                                                <h2 class="visual_txt_tit"><span>${banner.description}</span></h2>
                ...
                <c:if test="${contentPromotion.promotionId ne 0}" > <!-- 이벤트가 있으면 보이게 한다 -->
                ...
                <div class="section_review_list">
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <span class="graph_mask"> <em class="graph_value" style="width: ${avgScore*20}%;"></em> </span>
                            ...
                            <ul class="list_short_review">
                                <c:forEach items="${commentList}" var="commentInfo" end="2">
                                <li class="list_item">
                                    <div>
                                        <div class="review_area">
                                            ...
                                            <h4 class="resoc_name">${contentPromotion.description}</h4>
                                            <p class="review">${commentInfo.comment}</p>
                                        </div>
                                        <div class="info_area">
                                            <div class="review_info"> <span class="grade">${commentInfo.score}</span> <span class="name">${commentInfo.reservationName}</span> <span class="date"><fmt:formatDate value="${commentInfo.createDate}" pattern="yyyy.MM.dd. "/>방문</span> </div>
                                        </div>
                                    </div>
                                </li>
                                </c:forEach>    
                    ...
                    <a class="btn_review_more" href="./review.html?id=${contentPromotion.productId}"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
                    ...
                    <div class="detail_location hide">
                        <div class="box_store_info no_topline">
                            <a href="#" class="store_location" title="지도웹으로 연결">
                                <img class="store_map img_thumb" alt="map" src="${detailLocation.mapImage}">
                                <span class="img_border"></span>
                                <span class="btn_map"><i class="spr_book2 ico_mapview"></i></span>
                            </a>
                            <h3 class="store_name">${contentPromotion.description}</h3>
                            <div class="store_info">
                                <div class="store_addr_wrap">
                                    <span class="fn fn-pin2"></span>
                                    <p class="store_addr store_addr_bold">${detailLocation.placeStreet}</p>
                                    <p class="store_addr">
                                        <span class="addr_old">지번</span>
                                        <span class="addr_old_detail">${detailLocation.placeLot}</span>
                                    </p>
                                    <p class="store_addr addr_detail">${detailLocation.placeName}</p>
                                </div>
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> 
                                            ...
                                            <span class="item_rt"> 
                                                <a href="tel:${detailLocation.tel}" class="store_tel">${detailLocation.tel}</a>
                                            </span> 
                                        </li>
                                    </ul>
                                </div>
    ...
    <footer>
        ...
        <div class="footer">
            <p class="dsc_footer">네이버(주)는 통신판매의 당사자가 아니며, 상품의정보, 거래조건, 이용 및 환불 등과 관련한 의무와 책임은 각 회원에게 있습니다.${id}</p>
